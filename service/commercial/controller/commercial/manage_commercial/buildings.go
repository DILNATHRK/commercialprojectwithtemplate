...
func InsertBasicBuildingDetailInDB(name string, location string, availability_for string, completion_status string, furnishing_status string, no_of_floor string, parking string, lift string, oc string, overlooking string) (id int64) {
	...
	doc := models.Building{Name: name, Location: location, AvailabilityFor: availability_for, CompletionStatus: completion_status, FurnishingStatus: furnishing_status, Floors: no_of_floor, Parking: parking, Lift: lift, Oc: oc, OverLooking: overlooking}
